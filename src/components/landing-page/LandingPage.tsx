          ...
          <FadeIn>
            <div className="max-w-2xl mx-auto text-center bg-background/80 rounded-3xl p-8 md:p-12">
              ...
              <p className="mb-6 text-foreground/80">
                We&apos;ve developed a proprietary technology using plant
                science and machine learning to understand what plants need at
                every moment. This approach enables precise cultivation,
                optimizing growth conditions for each plant and maximizing
                vanilla bean production in a sustainable way.
              </p>
            ...
            <FadeIn>
              <div className="md:w-1/2">
                ...
                <p className="mb-6 text-foreground/80">
                  ...
                  properties and notes. Whether you want to emphasize the
                  floral, woody, or spicy characteristics of vanilla, our
                  controlled growing conditions and processing methods can
