      ...
      <div className="container px-4 py-8 md:py-12">
        <div className="flex flex-col space-y-8">
          ...
          <div className="flex items-center">
            ...
            <h1 className="text-3xl font-extrabold tracking-tight mt-6 -ml-8 text-white">
              BlueRedGold
            </h1>
          </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
            <nav className="lg:col-span-12 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
